...
interface SelectAuthorOptionProps {
onAuthorChange: (author: string) => void;
  value: string;
}

const SelectAuthorOption: React.FC<SelectAuthorOptionProps> = ({ value, onAuthorChange }) => {
  const { authors }: any = useContext(DataContext);
...
export default SelectAuthorOption;
